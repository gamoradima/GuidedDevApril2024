namespace Terrasoft.Configuration
{
    ...
    public class RealtyService : BaseService, IReadOnlySessionState
    {
            ...
            string entityName)
        {
            ...
            if (!UserConnection.DBSecurityEngine.GetCanExecuteOperation("CanRunMySuperWebService"))
            {
                return -2;
            };
            Select select = new Select(UserConnection)   // select Max(UsrPriceUSD) from UsrRealty where UsrTypeId = ... AND UsrOfferTypeId = ...
        ...
        public string GetExample(string P)
        {
            return "P = " + P + "; OK!";
        }
