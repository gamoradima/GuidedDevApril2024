	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_cv8umsh_caption)#",
					"color": "primary",
					"disabled": false,
					"size": "medium",
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_oxfsq1j_caption)#",
					"visible": true,
					"clicked": {
			...
			{
				"operation": "insert",
				"name": "MenuItem_2hlfll6",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_2hlfll6_caption)#",
					"visible": true,
					"clicked": {
						"request": "crt.RunBusinessProcessRequest",
						"params": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrType_q7we2oz;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.PDS_UsrColumn5_by312k4;
					var offerTypeId = "";
					if (offerTypeObject) {
					...
					const P =  "my super data";
					const getUrl = Terrasoft.combinePath(baseUrl, transferName, serviceName, "GetExample?P=" + P);
					const response2 = await httpClientService.get(getUrl);
					this.console.log("response2 = " + response2.body.GetExampleResult);
